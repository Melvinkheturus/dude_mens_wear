...
import { ProductsService, type Category, type Product } from "@/lib/services/products"
...
function CategorySection({ category }: CategorySectionProps) {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const categoryProducts = await ProductsService.getProductsByCategory(category.slug, 8)
