...
import { getAllCategories, getProductsByCategory, type DemoCategory, type DemoProduct } from "@/lib/demo-data"
...
export default function MegaMenu({ onClose }: MegaMenuProps) {
  ...
  // All categories are parent categories in demo data
  const parentCategories = categories
  
  // Helper to get products for a category
  const getCategoryProductsDisplay = (categorySlug: string) => {
    return getProductsByCategory(categorySlug).slice(0, 8)
  }
      ...
      <div className="flex h-full w-full">
        ...
        >
          {parentCategories.length === 0 ? (
            ...
            parentCategories.map((category) => {
              const categoryProducts = getCategoryProductsDisplay(category.slug)
